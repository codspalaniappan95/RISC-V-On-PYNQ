...
proc create_hier_cell_tutorialProcessor { parentCell nameHier } {
  ...
  set picorv32_axi_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:picorv32_axi:1.0 picorv32_axi_0 ]
 ...
 ] [get_bd_intf_pins /tutorialProcessor/picorv32_axi_0/mem_axi]
  ...
  connect_bd_intf_net -intf_net picorv32_axi_0_mem_axi [get_bd_intf_pins picorv32_axi_0/mem_axi] [get_bd_intf_pins riscvBramController/S_AXI]
  ...
  connect_bd_net -net riscvReset_peripheral_aresetn [get_bd_pins picorv32_axi_0/resetn] [get_bd_pins riscvBramController/s_axi_aresetn] [get_bd_pins riscvReset/peripheral_aresetn]
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins s_axi_aresetn] [get_bd_pins psBramController/s_axi_aresetn]
  connect_bd_net -net subprocessorClk [get_bd_pins riscv_clk] [get_bd_pins picorv32_axi_0/clk] [get_bd_pins riscvBramController/s_axi_aclk] [get_bd_pins riscvReset/slowest_sync_clk]
...
proc create_root_design { parentCell } {
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x00000000 [get_bd_addr_spaces tutorialProcessor/picorv32_axi_0/mem_axi] [get_bd_addr_segs tutorialProcessor/riscvBramController/S_AXI/Mem0] SEG_riscvBramController_Mem0
